        ...
        <main className="stage">
          {isEmpty ? (
            <div className="stage__empty">
              ...
              <p>
                Drop in GPX, TCX or FIT files — or load the samples — and pick a layout. Everything
                happens in your browser; no files are uploaded anywhere.
              </p>
            </div>
          ) : (
